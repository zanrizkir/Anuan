...
<div class="container-fluid">
  <div class="row justify-content-center">
    <div class="col-12">
      <h2 class="mb-2 page-title">Data Subkategori</h2>
      <div class="row my-4">
        <!-- Small table -->
        <div class="col-md-12">
                  ...
                  @if (count($sub))
                    @foreach ($sub as $subs)
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('subkategori.destroy', $subs->id) }}" method="post">
                                    @csrf
                                    @method('delete')
                                    <a href="{{ route('subkategori.edit', $subs->id) }}"
                                    ...
                                    <div class="modal fade" id="defaultModal" tabindex="-1" role="dialog" aria-labelledby="defaultModalLabel {{ $subs->id }}" aria-hidden="true">
